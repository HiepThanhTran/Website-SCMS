		...
		<>
			...
			<Carousel>
				<Carousel.Item>
					...
					<Carousel.Caption>
						...
						<p>
							Đảm bảo hàng hóa của bạn đến nơi đúng hẹn và trong
							tình trạng tốt nhất.
						</p>
					</Carousel.Caption>
				</Carousel.Item>
				...
				<Carousel.Item>
					...
					<Carousel.Caption>
						...
						<p>
							Chúng tôi cam kết bảo vệ hàng hóa của bạn với các
							giải pháp kho bãi an toàn và đáng tin cậy.
						</p>
					</Carousel.Caption>
				</Carousel.Item>
				...
				<Carousel.Item>
					...
					<Carousel.Caption>
						...
						<p>
							Chúng tôi có đội ngũ nhân viên giàu kinh nghiệm,
			...
			<Container className="container p-5 content-container">
				<div className="content__subject">
					<h1 className="content__subject__title text-center">
						Tầm nhìn và sứ mệnh
					</h1>
					<span></span>
				</div>
					...
					<Col sm={6}>
						<div className="card text-center border-0 shadow rounded-0 p-3 card-principles">
							...
							<div className="card-body">
								<h4 className="card-principles__title fw-bold">
									Tầm nhìn
								</h4>
								<p className="card-principles__text">
									Trở thành đối tác hàng đầu trong ngành
									logistics và quản lý kho bãi, dẫn đầu về
									công nghệ và dịch vụ khách hàng trên toàn
									cầu.
								</p>
							</div>
						</div>
					...
					<Col sm={6}>
						<div className="card text-center border-0 shadow rounded-0 p-3 card-principles">
							...
							<div className="card-body">
								...
								<p className="card-principles__text">
									Chúng tôi cung cấp các giải pháp logistics
									và quản lý kho bãi tối ưu, giúp khách hàng
					...
					<div className="col-3 col-custom">
						<div className="card text-center border-0 shadow card-corevalue">
							...
							<div className="card-corevalue__body mt-5 p-3">
								<h5 className="card-corevalue__body--title fw-5">
									Đổi mới
								</h5>
								<p className="card-corevalue__body--text fw-3">
									Luôn cải tiến và áp dụng công nghệ mới để
									mang lại giải pháp tối ưu nhất.
								</p>
							</div>
						</div>
					</div>
					...
					<div className="col-3 col-custom">
						<div className="card text-center border-0 shadow card-corevalue">
							...
							<div className="card-corevalue__body mt-5 p-3">
								...
								<p className="card-corevalue__body--text fw-3">
									Đảm bảo chất lượng dịch vụ và độ chính xác
									trong mọi giao dịch.
								</p>
							</div>
						</div>
					...
					<div className="col-3 col-custom">
						<div className="card text-center border-0 shadow card-corevalue">
							...
							<div className="card-corevalue__body mt-5 p-3">
								...
								<p className="card-corevalue__body--text fw-3">
									Đặt nhu cầu và sự hài lòng của khách hàng
									lên hàng đầu.
								</p>
							</div>
						</div>
